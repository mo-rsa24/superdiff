...
visualize_forward_diffusion_process_of_all_groups_over_time(steps, shapes, lim=(-20,20), title="Forward Diffusion Over All Shapes")
...
visualize_forward_and_reverse_diffusion_on_all_latents(steps, trajectories, shapes, lim=(-20,20), title="Forward & Reverse Diffusion Over All Shapes")
...
visualize_compositions(trajectory, steps, shapes, lim=(-20,20), title="Sampling From An Iso-Surface Of Squares & Circles")
...
visualize_log_likelihood_along_superposed_trajectory(log_likelihood_model_a, log_likelihood_model_b)
visualize_compositions(trajectory, steps, shapes, lim=(-20,20), title="Sampling From An Iso-Surface Of Triangles & Circles")
...
visualize_log_likelihood_along_superposed_trajectory(log_likelihood_model_a, log_likelihood_model_b)
visualize_compositions(trajectory, steps, shapes, lim=(-20,20), title="Sampling From An Iso-Surface Of Triangles & Squares")